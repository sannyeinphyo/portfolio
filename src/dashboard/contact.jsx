...
export default function ContactSection() {
  ...
  return (
    <div className="relative min-h-screen rounded-2xl bg-white dark:bg-gray-900 text-slate-900 dark:text-white flex items-center justify-center p-4 md:p-8 transition-colors duration-500 overflow-hidden">
